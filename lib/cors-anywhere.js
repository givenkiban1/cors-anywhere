...
function withCORS(headers, request) {
  ...
  //     headers['Given'] = headers['set-cookie'];
  // }
  ...
  // h["Given"] = headers["set-cookie"];
  // h["cookie"] = headers["set-cookie"];
  
  // console.log("thi is headers h");
  // console.log(h);
  

  headers['access-control-expose-headers'] = Object.keys(headers).join(',') + ",Given,Given2";
  console.log("this is headers original");
  console.log(headers);
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  if(true){//req.corsAnywhereRequestState.enableCookies
    ...
    console.log("type of ", typeof proxyRes.headers['set-cookie']);
    console.log("type of ", typeof proxyRes.headers['set-cookie2']);
    ...
    if(typeof proxyRes.headers['set-cookie'] === "object"){
      ...
      console.log("set cookies is avaialble");
    ...
    if(typeof proxyRes.headers['set-cookie2'] === "object"){
      ...
      console.log("set cookies 2 is avaialble");
      //console.log(proxyRes.headers);
    }
    else{
      console.log("set cookies is not avaialble");
      //console.log(proxyRes.headers);
    }
  }else{
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    //console.log("cors anywhere", corsAnywhere);
    ...
    console.log("gift is of type", typeof req.headers["gift"]);
    if (typeof req.headers["gift"] === "object")
        req.headers["cookie"] = req.headers["gift"]

    console.log("given is", req.headers["given"]);

    console.log("gift is", req.headers["gift"]);
    //console.log("Given is", req.headers["Given"]);
    
    console.log("cookie var is", req.headers["cookie"] );
